...
class AdaBound(Optimizer):
    ...
    The implementation was taken from https://github.com/titu1994/keras-adabound
    with some purely cosmetic modifications
    """
    def __init__(self,
                 learning_rate=0.001,
        ...
        self._set_hyper('learning_rate',
                        kwargs.get('learning_rate', learning_rate))
        self._set_hyper('final_learning_rate',
                        kwargs.get('final_learning_rate', final_learning_rate))
