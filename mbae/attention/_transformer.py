...
class TransformerAttention(mbae.attention._base.QKVAttention):
    ...
    @property
    def masker(self) -> t.Optional[mbae.attention._base.AttentionMasker]:
        return self.attention.masker

    def __init__(self,
                 r: int,
                 d_r: int,
                 attention: mbae.attention._base.QKVAttention,
                 ffn_hid: int,
...
#     def __init__(self,
#                  depth: int,
#                  attention_constructor: t.Callable[[int], mbae.attention.base.QKVAttention],
