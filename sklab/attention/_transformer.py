...
import sklab.attention.base
import sklab.attention.layers
from sklab.attention import core, util
from sklab.attention.layers import KTensor


class TransformerAttention(sklab.attention.base.QKVAttention):
    """
    ...
    @property
    def masker(self) -> t.Optional[sklab.attention.base.AttentionMasker]:
        return self.attention.masker

    def __init__(self,
                 r: int,
                 d_r: int,
                 attention: sklab.attention.base.QKVAttention,
                 ffn_hid: int,
        ...
        self.norm_attention = sklab.attention.layers.LayerNormalisation()
        # ffn
        ...
        self.norm_ffn = sklab.attention.layers.LayerNormalisation()
...
#     def __init__(self,
#                  depth: int,
#                  attention_constructor: t.Callable[[int], sklab.attention.base.QKVAttention],
